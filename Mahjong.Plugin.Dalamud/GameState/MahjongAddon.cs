...
///
/// <para>Singleton in MEDI — collaborators take it as a constructor parameter.
/// The cache state lives on the instance so probe overhead is amortized across
/// the whole plugin lifetime, not per-caller.</para>
/// </summary>
